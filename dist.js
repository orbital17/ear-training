		...
		return A2(
			...
			_elm_lang$core$List$head(
				A2(
					...
					function (_p2) {
						var _p3 = _p2;
						return _elm_lang$core$Native_Utils.eq(_p3._1, a);
					},
					A2(
...
var _user$project$Utils$get = F2(
	function (i, l) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, i, l));
	});
var _user$project$Utils$randomFromList = function (list) {
	var gen = A2(
	...
	return A2(
		_elm_lang$core$Random$map,
		function (index) {
			return A2(_user$project$Utils$get, index, list);
		},
		gen);
};
...
var _user$project$Music$triadIndex = function (mask) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		A2(_user$project$Utils$indexOf, mask, _user$project$Music$triadMasks));
};
var _user$project$Music$triadOptions = function (scale) {
	...
	var inScale = function (chord) {
		return A2(
			...
			A2(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, extendedScale),
			chord);
	};
	var chordsFromNote = function (n) {
		return A2(
			_elm_lang$core$List$filter,
			inScale,
			A2(
				_elm_lang$core$List$map,
				makeTriad(n),
				_user$project$Music$triadMasks));
	};
	return A2(_elm_lang$core$List$concatMap, chordsFromNote, scale);
};
var _user$project$Music$triadNames = {
	ctor: '::',
	_0: 'maj',
	_1: {
		ctor: '::',
...
var _user$project$Music$triadName = function (i) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Unknown interval',
		A2(_user$project$Utils$get, i, _user$project$Music$triadNames));
};
			...
			A2(
				...
				function (root) {
					return A2(
						_elm_lang$core$List$map,
						function (top) {
							return {ctor: '_Tuple2', _0: root, _1: top};
						},
						A2(
							_elm_lang$core$Basics_ops['++'],
							scale,
...
var _user$project$Music$intervalNames = {
	ctor: '::',
	_0: 'Unison',
	_1: {
		ctor: '::',
...
var _user$project$Music$intervalName = function (i) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Unknown interval',
...
var _user$project$Music$toMelodic = function (chords) {
	return A2(
		_elm_lang$core$List$map,
		function (n) {
			return {
		...
		_elm_lang$core$List$concat(chords));
};
var _user$project$Music$transpose = function (n) {
...
var _user$project$Music$tonicOctave = {
	ctor: '::',
	_0: {
		ctor: '::',
		_0: 0,
...
var _user$project$Music$noteToString = function (n) {
	var octave = ((n / 12) | 0) - 1;
	var notes = {
		ctor: '::',
		_0: 'C',
	...
	var letter = A2(
		...
		A2(
			_user$project$Utils$get,
			A2(_elm_lang$core$Basics_ops['%'], n, 12),
			notes));
	return A2(
		_elm_lang$core$Basics_ops['++'],
		letter,
...
var _user$project$Music$syllable = function (n) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'_',
		A2(
...
var _user$project$Music$getNote = F2(
	function (mode, degree) {
		var d = degree - 1;
		var nOctaves = (d / 7) | 0;
		var modDegree = A2(_elm_lang$core$Basics_ops['%'], d, 7);
		var note = A2(
			_elm_lang$core$Maybe$withDefault,
			-100,
			A2(
				_user$project$Utils$get,
				modDegree,
				_user$project$Music$modeNotes(mode)));
		return note + (12 * nOctaves);
	});
var _user$project$Music$getChord = F2(
	function (mode, degree) {
		return A2(
			_elm_lang$core$List$map,
			function (i) {
				return A2(_user$project$Music$getNote, mode, degree + (i * 2));
			},
			A2(_elm_lang$core$List$range, 0, 2));
	});
var _user$project$Music$getCadence = function (mode) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Music$getChord(mode),
		{
			ctor: '::',
			_0: 1,
			_1: {
	...
	function (mode, chords) {
		...
		var note = A2(
			...
			A2(
				...
				_elm_lang$core$List$head,
				_elm_lang$core$List$head(chords)));
		var index = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(
				...
				notes));
		var descending = _elm_lang$core$List$reverse(
			A2(_elm_lang$core$List$take, index + 1, notes));
		var ascending = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$drop, index, notes),
			{
				ctor: '::',
				_0: 12,
				_1: {ctor: '[]'}
			});
		var nOctaves = (note / 12) | 0;
		return A2(
			_elm_lang$core$List$map,
			function (n) {
				return {
			...
			(_elm_lang$core$Native_Utils.cmp(index, 4) < 0) ? descending : ascending);
	});
			...
			switch (_p12) {
				case 1:
					return A2(
						...
						_user$project$Music$modeNotes(mode));
				case 2:
					return _user$project$Music$intervalsOptions(
						_user$project$Music$modeNotes(mode));
				case 3:
					return _user$project$Music$triadOptions(
						_user$project$Music$modeNotes(mode));
				default:
					return {ctor: '[]'};
			}
...
var _user$project$Types$allGuessed = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		model.guessed.chords,
		_elm_lang$core$List$length(model.chordsToGuess));
};
var _user$project$Types$questionToString = function (q) {
	var _p0 = q.qType;
	switch (_p0.ctor) {
		case 'Degree':
...
var _user$project$Types$getOptions = F2(
	function (m, t) {
		var answerOption = F3(
			function (name, index, keyMap) {
				return {name: name, index: index, keyMap: keyMap};
			});
		var _p1 = t;
		switch (_p1.ctor) {
			case 'Degree':
				return A2(
					...
					function (n) {
						return {
							name: _user$project$Music$syllable(n),
							index: n,
							keyMap: A2(
								_elm_lang$core$Maybe$withDefault,
								_elm_lang$core$Native_Utils.chr('d'),
								A2(_user$project$Utils$get, n, _user$project$Types$gammaKeyMap))
						};
					},
...
var _user$project$Types$getOptionsFromModel = function (m) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		A2(
			_elm_lang$core$Maybe$map,
			_user$project$Types$getOptions(m.settings.mode),
			A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.qType;
...
var _user$project$Types$ChangeSettings = function (a) {
	return {ctor: 'ChangeSettings', _0: a};
};
var _user$project$Types$StartExercises = {ctor: 'StartExercises'};
var _user$project$Types$MakeGuess = function (a) {
	return {ctor: 'MakeGuess', _0: a};
};
var _user$project$Types$Exercise = function (a) {
	return {ctor: 'Exercise', _0: a};
};
var _user$project$Types$NewExercise = {ctor: 'NewExercise'};
var _user$project$Types$PlayCustomDelay = F2(
	function (a, b) {
		return {ctor: 'PlayCustomDelay', _0: a, _1: b};
	});
...
var _user$project$Types$getQuestion = function (m) {
	...
	var degree = function (n) {
		return {
			...
			answer: A2(_elm_lang$core$Basics_ops['%'], n, 12)
		};
	};
	var name = function (chord) {
		var _p2 = chord;
		_v2_2:
		do {
			if ((_p2.ctor === '::') && (_p2._1.ctor === '::')) {
				if (_p2._1._1.ctor === '[]') {
					return {qType: _user$project$Types$IntervalName, answer: _p2._1._0 - _p2._0};
				} else {
					if (_p2._1._1._1.ctor === '[]') {
						var _p3 = _p2._1._0;
						return {
							qType: _user$project$Types$TriadName,
							answer: _user$project$Music$triadIndex(
								{ctor: '_Tuple2', _0: _p3 - _p2._0, _1: _p2._1._1._0 - _p3})
						};
					} else {
						break _v2_2;
					}
	...
	return function (q) {
		return _elm_lang$core$Native_Utils.eq(q, _elm_lang$core$Maybe$Nothing) ? m.currentQuestion : q;
	}(
		A2(_elm_lang$core$Maybe$map, question, currentChord));
};
var _user$project$Types$nextQuestion = function (m) {
	var g = m.guessed;
	var currentChordSize = _elm_lang$core$List$length(
		A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
...
var _user$project$Types$initModel = {
	...
	settings: _user$project$Types$initSettings,
	chordsToGuess: {ctor: '[]'},
	...
	var settingField = F2(
		function (title, inputs) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('settings-field'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('setting-label'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$View$answerLine = function (m) {
	var chordNameCell = F2(
	...
	return A2(
		...
		_elm_lang$html$Html$div(
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('answer-chord-column'),
				_1: {ctor: '[]'}
			}),
		A2(_elm_lang$core$List$indexedMap, chordColumn, m.chordsToGuess));
};
var _user$project$View$answerButton = F2(
	function (m, answerOption) {
		var isRightAnswer = A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
				_elm_lang$core$Maybe$map,
				function (q) {
					return _elm_lang$core$Native_Utils.eq(q.answer, answerOption.index);
				},
				m.currentQuestion));
		var attemted = A2(_elm_lang$core$Set$member, answerOption.index, m.attemps);
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'is-danger', _1: attemted},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'is-info', _1: !attemted},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'is-success',
											_1: _user$project$Types$allGuessed(m) && isRightAnswer
										},
										_1: {ctor: '[]'}
									}
								}
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Types$MakeGuess(answerOption.index)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$View$answerButtons = function (m) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$View$answerButton(m),
		_user$project$Types$getOptionsFromModel(m));
};
var _user$project$View$actionButton = F5(
	function (msg, title, keyBinding, isDisabled, isHidden) {
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'pure-button is-info is-outlined', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'hidden', _1: isHidden},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
...
var _user$project$View$actionButtons = function (m) {
	var b = _user$project$View$actionButton;
	return {
		ctor: '::',
		_0: A5(
			b,
					...
					_1: {
						...
						_0: A5(
							...
							A2(
								_user$project$Types$PlayCustomDelay,
								0.5,
								A2(_user$project$Music$getSequenceToTonic, m.settings.mode, m.chordsToGuess)),
							'Hear sequence to tonic',
							'',
							!_user$project$Types$allGuessed(m),
							(_elm_lang$core$Native_Utils.cmp(m.settings.chordSize, 1) > 0) || ((_elm_lang$core$Native_Utils.cmp(m.settings.chordsInSequence, 1) > 0) || m.settings.autoProceed)),
						_1: {
							ctor: '::',
							_0: A5(
								b,
...
var _user$project$View$quiz = function (m) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(m.stat.correct),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' of ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(m.stat.total),
								' correct')))),
				_1: {ctor: '[]'}
			}),
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$View$actionButtons(m)),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$View$content = function (m) {
	var _p1 = m.page;
	switch (_p1.ctor) {
		case 'ExercisePage':
			return A2(
...
var _user$project$View$nav = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('nav-center title'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Ear Training'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
...
var _user$project$Storage$settingsEndoder = function (s) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'root',
				_1: _elm_lang$core$Json_Encode$int(s.root)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$int(
						_user$project$Storage$modeToInt(s.mode))
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'guessChordName',
						_1: _elm_lang$core$Json_Encode$bool(s.guessChordName)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'autoProceed',
							_1: _elm_lang$core$Json_Encode$bool(s.autoProceed)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'chordSize',
								_1: _elm_lang$core$Json_Encode$int(s.chordSize)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'chordsInSequence',
									_1: _elm_lang$core$Json_Encode$int(s.chordsInSequence)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'delay',
										_1: _elm_lang$core$Json_Encode$float(s.delay)
									},
									_1: {ctor: '[]'}
								}
							}
...
var _user$project$Storage$intToMode = function (i) {
	var _p1 = i;
	if (_p1 === 1) {
		return _user$project$Music$Minor;
	} else {
		return _user$project$Music$Major;
	}
};
var _user$project$Storage$settingsDecoder = A8(
	_elm_lang$core$Json_Decode$map7,
	_user$project$Types$Settings,
	A2(_elm_lang$core$Json_Decode$field, 'root', _elm_lang$core$Json_Decode$int),
	A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$Storage$intToMode,
		A2(_elm_lang$core$Json_Decode$field, 'mode', _elm_lang$core$Json_Decode$int)),
	A2(_elm_lang$core$Json_Decode$field, 'guessChordName', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'autoProceed', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'chordSize', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'chordsInSequence', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'delay', _elm_lang$core$Json_Decode$float));
var _user$project$Storage$enableStorage = true;
var _user$project$Storage$localStorageSet = _elm_lang$core$Native_Platform.outgoingPort(
	'localStorageSet',
	function (v) {
		return v;
	});
var _user$project$Storage$setSettings = function (s) {
	return _user$project$Storage$localStorageSet(
		_user$project$Storage$enableStorage ? A2(
			_elm_lang$core$Json_Encode$encode,
			0,
			_user$project$Storage$settingsEndoder(s)) : '');
};
var _user$project$Storage$localStorageGet = _elm_lang$core$Native_Platform.outgoingPort(
	'localStorageGet',
	function (v) {
		return null;
	});
var _user$project$Storage$localStorageSub = _elm_lang$core$Native_Platform.incomingPort('localStorageSub', _elm_lang$core$Json_Decode$string);
var _user$project$Storage$settingsSub = function (f) {
	var g = function (value) {
		return f(
			_elm_lang$core$Result$toMaybe(
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Storage$settingsDecoder, value)));
	};
	return _user$project$Storage$localStorageSub(
		_user$project$Storage$enableStorage ? g : function (_p2) {
			return f(_elm_lang$core$Maybe$Nothing);
		});
};

var _user$project$Main$keyboardMap = F2(
	function (model, key) {
		var answer = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (option) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _elm_lang$keyboard$Keyboard$presses(
				function (_p2) {
					return A2(
						_user$project$Main$keyboardMap,
						m,
...
var _user$project$Main$getRandomChords = function (s) {
	...
	var getChord = A3(
		...
		transpose,
		A2(_elm_lang$core$Random$int, 0, 1),
		A2(_user$project$Music$getRandom, s.mode, s.chordSize));
...
var _user$project$Main$countExercise = function (model) {
	...
	return {
		total: stat.total + 1,
		correct: model.error ? stat.correct : (stat.correct + 1)
	};
};
var _user$project$Main$playChordsPort = _elm_lang$core$Native_Platform.outgoingPort(
	'playChordsPort',
	function (v) {
		return [
...
var _user$project$Main$play = F3(
	function (root, timeInterval, chords) {
		return _user$project$Main$playChordsPort(
			{
				ctor: '_Tuple2',
				_0: A2(
					_elm_lang$core$List$map,
					_user$project$Music$transpose(root),
					chords),
				_1: timeInterval
			});
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'NewExercise':
				return _user$project$Types$allGuessed(model) ? _user$project$Main$getNewExercise(model) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{ctor: '[]'});
			case 'MakeGuess':
					...
					if (_p5._0 === true) {
						...
						return _user$project$Types$allGuessed(newModel) ? (model.settings.autoProceed ? _user$project$Main$getNewExercise(
							_elm_lang$core$Native_Utils.update(
								newModel,
								{
									stat: _user$project$Main$countExercise(newModel)
								})) : A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								newModel,
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$Types$initModel,
			{
				ctor: '::',
				_0: _user$project$Storage$localStorageGet(
					{ctor: '_Tuple0'}),
				_1: {ctor: '[]'}
			}),
		view: _user$project$View$view,
		update: _user$project$Main$debugUpdate,
